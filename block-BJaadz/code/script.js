...
let hrWithClassImage = document.querySelectorAll("hr.image");
hrWithClassImage.forEach((ele) => ele.style.border = `2px solid purple`);
...
oddBox.forEach((ele) => ele.style.background= "aliceblue");
...
anchorAltCampus.text ="AltCampus";
anchorGoogle.text = "Google";
...
boxFive.append(anchorAltCampus);
boxFive.append(anchorGoogle);